...
{
//	__android_log_print(ANDROID_LOG_INFO, "PVRShell", "LoadFileFunc %s", pFilename);
...
*************************************************************************/
void PVRShellInit::OsDisplayDebugString(char const * str)
{
...
//	__android_log_print(ANDROID_LOG_INFO, pszAppName ? pszAppName : "PVRShell", str);
	__android_log_print(ANDROID_LOG_INFO, "PVRShell", "%s", str);
}
